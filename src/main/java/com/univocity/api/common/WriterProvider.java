...
public abstract class WriterProvider implements ResourceProvider<Writer> {
	 ...
	 * <ul>
	 * 	<li>if false: The underlying resource has data already and no headers will be written</li>
	 *  <li>if true: The underlying resource is empty and headers will be written to it</li>
	 * </ul>
	 *
