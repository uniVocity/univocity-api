...
/**
 * This is the parent class for all configuration classes that define the format of text parsed by uniVocity.
 *
 ...
 *
 */
public abstract class BasicTextFormat extends Configuration {
	...
	protected void copyDefaultsFrom(Configuration defaultConfig) {
		BasicTextFormat defaults = (BasicTextFormat) defaultConfig;
