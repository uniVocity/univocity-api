...
public final class JdbcEntityConfiguration extends BaseJdbcEntityConfiguration {
	...
	private Boolean batchRetryEnabled = null;
	...
	protected final void copyDefaultsFrom(Configuration defaultsObject) {
		...
		if(this.batchRetryEnabled == null){
			this.batchRetryEnabled = defaults.isBatchRetryEnabled();
		}
	}
	 ...
	 * </p>
	 *
	 * @return {@code true} if failed batch operations should be retried, {@code false} otherwise.
	 */
	public boolean isBatchRetryEnabled() {
		if (batchRetryEnabled == null) {
			return false;
		}
		return batchRetryEnabled;
	}
	 ...
	 * </p>
	 *
	 * @param batchRetryEnabled a flag indicating whether or not batch operations should be retried.
	 */
	public void setBatchRetryEnabled(boolean batchRetryEnabled) {
		this.batchRetryEnabled = batchRetryEnabled;
	}
}
