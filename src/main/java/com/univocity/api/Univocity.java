...
public final class Univocity {
	...
	static final String API_VERSION = "1.1.0";
	...
	public static final DataStreamingProcess getDataStream(DataStreamConfiguration streamingEngineConfiguration){
		return engineFactory().getDataStream(streamingEngineConfiguration);
	}
}
