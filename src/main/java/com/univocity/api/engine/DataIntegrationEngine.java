...
public interface DataIntegrationEngine {
	...
	/**
	 * Removes a mapping between two data stores. All configuration settings defined in the underlying {@link DataStoreMapping} will be lost.
	 * @param sourceDataStore the name of the source data store.
	 * @param destinationDataStore the name of the destination data store. Source and destination data stores can be the same.
	 */
	...
	/**
	 * Executes a data mapping cycle with all mappings configured in this engine using (i.e. through {@link #map(String, String)}).
